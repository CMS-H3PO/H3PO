...
def fillHistos(label, event_counts, extraHistos, SR_fail_fj, SR_pass_fj, VR_fail_fj, VR_pass_fj, SR_fail_e=None, SR_pass_e=None, VR_fail_e=None, VR_pass_e=None, refTrigList=None, trigList=None):
	if refTrigList != None:
		# SR fail
	...
	jet1_higgs_SR_fail = SR_fail_fj[:,0][higgsCandidateMask_SR(SR_fail_fj[:,0])]
	jet2_higgs_SR_fail = SR_fail_fj[:,1][higgsCandidateMask_SR(SR_fail_fj[:,1])]
	jet1_y_SR_fail = SR_fail_fj[:,0][yCandidateMask_SR(SR_fail_fj[:,0])]
	jet2_y_SR_fail = SR_fail_fj[:,1][yCandidateMask_SR(SR_fail_fj[:,1])]


	jet1_higgs_SR_pass = SR_pass_fj[:,0][higgsCandidateMask_SR(SR_pass_fj[:,0])]
	jet2_higgs_SR_pass = SR_pass_fj[:,1][higgsCandidateMask_SR(SR_pass_fj[:,1])]
	jet1_y_SR_pass = SR_pass_fj[:,0][yCandidateMask_SR(SR_pass_fj[:,0])]
	jet2_y_SR_pass = SR_pass_fj[:,1][yCandidateMask_SR(SR_pass_fj[:,1])]



	jet1_higgs_VR_fail = VR_fail_fj[:,0][higgsCandidateMask_VR(VR_fail_fj[:,0])]
	jet2_higgs_VR_fail = VR_fail_fj[:,1][higgsCandidateMask_VR(VR_fail_fj[:,1])]
	jet1_y_VR_fail = VR_fail_fj[:,0][yCandidateMask_VR(VR_fail_fj[:,0])]
	jet2_y_VR_fail = VR_fail_fj[:,1][yCandidateMask_VR(VR_fail_fj[:,1])]


	jet1_higgs_VR_pass = VR_pass_fj[:,0][higgsCandidateMask_VR(VR_pass_fj[:,0])]
	jet2_higgs_VR_pass = VR_pass_fj[:,1][higgsCandidateMask_VR(VR_pass_fj[:,1])]
	jet1_y_VR_pass = VR_pass_fj[:,0][yCandidateMask_VR(VR_pass_fj[:,0])]
	jet2_y_VR_pass = VR_pass_fj[:,1][yCandidateMask_VR(VR_pass_fj[:,1])]
	...
	hists["mj_vs_mjj_SR_fail"].fill(jet_mass_SR_fail=jet1_y_mass_SR_fail, dijet_mass_SR_fail=dijet_mass_SR_fail[yCandidateMask_SR(SR_fail_fj[:,0])])
	hists["mj_vs_mjj_SR_fail"].fill(jet_mass_SR_fail=jet2_y_mass_SR_fail, dijet_mass_SR_fail=dijet_mass_SR_fail[yCandidateMask_SR(SR_fail_fj[:,1])])
	...
	hists["mj_vs_mjj_SR_pass"].fill(jet_mass_SR_pass=jet1_y_mass_SR_pass, dijet_mass_SR_pass=dijet_mass_SR_pass[yCandidateMask_SR(SR_pass_fj[:,0])])
	hists["mj_vs_mjj_SR_pass"].fill(jet_mass_SR_pass=jet2_y_mass_SR_pass, dijet_mass_SR_pass=dijet_mass_SR_pass[yCandidateMask_SR(SR_pass_fj[:,1])])
	...
	hists["mj_vs_mjj_VR_fail"].fill(jet_mass_VR_fail=jet1_y_mass_VR_fail, dijet_mass_VR_fail=dijet_mass_VR_fail[yCandidateMask_VR(VR_fail_fj[:,0])])
	hists["mj_vs_mjj_VR_fail"].fill(jet_mass_VR_fail=jet2_y_mass_VR_fail, dijet_mass_VR_fail=dijet_mass_VR_fail[yCandidateMask_VR(VR_fail_fj[:,1])])
	...
	hists["mj_vs_mjj_VR_pass"].fill(jet_mass_VR_pass=jet1_y_mass_VR_pass, dijet_mass_VR_pass=dijet_mass_VR_pass[yCandidateMask_VR(VR_pass_fj[:,0])])
	hists["mj_vs_mjj_VR_pass"].fill(jet_mass_VR_pass=jet2_y_mass_VR_pass, dijet_mass_VR_pass=dijet_mass_VR_pass[yCandidateMask_VR(VR_pass_fj[:,1])])
	...
	deltaEta_SR_fail_bin = hist.axis.Regular(label=f"{label} Signal Fail Delta #eta", name="deltaEta_SR_fail", bins=eta_bins, start=eta_start, stop=eta_stop)
	...
	deltaEta_SR_pass_bin = hist.axis.Regular(label=f"{label} Signal Pass Delta #eta", name="deltaEta_SR_pass", bins=eta_bins, start=eta_start, stop=eta_stop)
	...
	deltaEta_VR_fail_bin = hist.axis.Regular(label=f"{label} Validation Fail Delta #eta", name="deltaEta_VR_fail", bins=eta_bins, start=eta_start, stop=eta_stop)
	...
	deltaEta_VR_pass_bin = hist.axis.Regular(label=f"{label} Validation Pass Delta #eta", name="deltaEta_VR_pass", bins=eta_bins, start=eta_start, stop=eta_stop)
	...
	deltaPhi_SR_fail_bin = hist.axis.Regular(label=f"{label} Signal Fail Delta #phi", name="deltaPhi_SR_fail", bins=phi_bins, start=phi_start, stop=phi_stop)
	...
	deltaPhi_SR_pass_bin = hist.axis.Regular(label=f"{label} Signal Pass Delta #phi", name="deltaPhi_SR_pass", bins=phi_bins, start=phi_start, stop=phi_stop)
	...
	deltaPhi_VR_fail_bin = hist.axis.Regular(label=f"{label} Validation Fail Delta #phi", name="deltaPhi_VR_fail", bins=phi_bins, start=phi_start, stop=phi_stop)
	...
	deltaPhi_VR_pass_bin = hist.axis.Regular(label=f"{label} Validation Pass Delta #phi", name="deltaPhi_VR_pass", bins=phi_bins, start=phi_start, stop=phi_stop)
...
def fillAllHistos(outHists, variation, event_counts, extraHistos, SR_b_fail_fj, SR_b_pass_fj, VR_b_fail_fj, VR_b_pass_fj, SR_b_fail_e=None, SR_b_pass_e=None, VR_b_fail_e=None, VR_b_pass_e=None, refTrigList=None, trigList=None):

	hists = {}
	hists["boosted"] = fillHistos("Boosted", event_counts, extraHistos, SR_b_fail_fj, SR_b_pass_fj, VR_b_fail_fj, VR_b_pass_fj, SR_b_fail_e, SR_b_pass_e, VR_b_fail_e, VR_b_pass_e, refTrigList, trigList)
...
if __name__ == "__main__":
	...
	for variation in variations:
		...
		SR_b_fail_e, SR_b_pass_e, SR_b_fail_fj, SR_b_pass_fj, VR_b_fail_e, VR_b_pass_e, VR_b_fail_fj, VR_b_pass_fj = Event_selection(input,process,event_counts,variation=variation, refTrigList=args.refTriggerList,trigList=args.triggerList,eventsToRead=None)

		# fill all histograms
		fillAllHistos(outHists, variation, event_counts, args.extra_histos, SR_b_fail_fj, SR_b_pass_fj, VR_b_fail_fj, VR_b_pass_fj)
		...
		if not saveOnceDone and variation in ["nominal","fromFile"]:
			...
			if args.refTriggerList != None:
				fillAllHistos(outHists, variation, event_counts, args.extra_histos, SR_b_fail_fj, SR_b_pass_fj, VR_b_fail_fj, VR_b_pass_fj, SR_b_fail_e, SR_b_pass_e, VR_b_fail_e, VR_b_pass_e, args.refTriggerList)
				# if the analysis trigger(s) are applied as well
				if args.triggerList != None:
					fillAllHistos(outHists, variation, event_counts, args.extra_histos, SR_b_fail_fj, SR_b_pass_fj, VR_b_fail_fj, VR_b_pass_fj, SR_b_fail_e, SR_b_pass_e, VR_b_fail_e, VR_b_pass_e, args.refTriggerList, args.triggerList)
