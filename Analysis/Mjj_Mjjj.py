...
if __name__ == "__main__":
    ...
    with uproot.recreate("Boosted_pass_50_{0}-{1}".format(process, file)) as fout:                                                                                                                        
    ...
    with uproot.recreate("Boosted_fail_50_{0}-{1}".format(process, file)) as fout:
    ...
    with uproot.recreate("semiBoosted_pass_50_{0}-{1}".format(process, file)) as fout:
    ...
    with uproot.recreate("semiBoosted_fail_50_{0}-{1}".format(process, file)) as fout:
