...
mjjj_sig0btag = ROOT.THStack("mjjj_sig0btag","MJJJ semiBoosted Signal Region 0 btag")
...
fin2 = ROOT.TFile.Open("./rootfiles/semiBoosted_QCD.root")
QCDj3_sig0btag = fin2.Get("j3_sig0btag_sb_hist")    
QCDj3_sig0btag.Sumw2()
QCDj3_sig0btag.SetFillColor(856)
mjjj_sig0btag.Add(QCDj3_sig0btag)

sig = ROOT.TFile.Open("./rootfiles/semiBoosted_XToYHTo6B_MX-2400_MY-800.root")
signal_sig0btag = sig.Get("j3_sig0btag_sb_hist")
signal_sig0btag.SetLineColor(2)

data = ROOT.TFile.Open("./rootfiles/semiBoosted_Data.root")
#data_sig0btag = data.Get("j3_sig0btag_sb_hist")
...
c1.Update()
c1.SaveAs("MJJJ_semiBoosted_Signal0btag.png")

mjjj_sig1btag = ROOT.THStack("mjjj_sig1btag","MJJJ semiBoosted Signal Region 1 btag")
...
QCDj3_sig1btag = fin2.Get("j3_sig1btag_sb_hist")
QCDj3_sig1btag.Sumw2()
QCDj3_sig1btag.SetFillColor(856)
mjjj_sig1btag.Add(QCDj3_sig1btag)

signal_sig1btag = sig.Get("j3_sig1btag_sb_hist")
signal_sig1btag.SetLineColor(2)

#data_sig1btag = data.Get("j3_sig1btag_sb_hist")
#data_sig1btag.SetMarkerStyle(20)

mjjj_sig1btag.SetMaximum(800)
...
c2.Update()
c2.SaveAs("MJJJ_semiBoosted_Signal1btag.png")


mjjj_CR0btag = ROOT.THStack("mjjj_CR0btag","MJJJ semiBoosted Control Region 0 btag")
c1 = ROOT.TCanvas('c1', 'c1')
...
QCDj3_CR0btag = fin2.Get("j3_CR0btag_sb_hist")
QCDj3_CR0btag.Sumw2()
QCDj3_CR0btag.SetFillColor(856)
mjjj_CR0btag.Add(QCDj3_CR0btag)

Signal_CR0btag = sig.Get("j3_CR0btag_sb_hist")
Signal_CR0btag.SetLineColor(2)

data_CR0btag = data.Get("j3_CR0btag_sb_hist")
...
c1.SaveAs("MJJJ_semiBoosted_CR0btag.png")

mjjj_CR1btag = ROOT.THStack("mjjj_CR1btag","MJJJ semiBoosted Control Region 1 btag")
c1 = ROOT.TCanvas('c1', 'c1')
...
QCDj3_CR1btag = fin2.Get("j3_CR1btag_sb_hist")
QCDj3_CR1btag.Sumw2()
QCDj3_CR1btag.SetFillColor(856)
mjjj_CR1btag.Add(QCDj3_CR1btag)

Signal_CR1btag = sig.Get("j3_CR1btag_sb_hist")
Signal_CR1btag.SetLineColor(2)

data_CR1btag = data.Get("j3_CR1btag_sb_hist")
...
c1.SaveAs("MJJJ_semiBoosted_CR1btag.png")
