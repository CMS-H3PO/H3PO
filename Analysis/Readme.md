...
```
ln -sfnv condor_jobs_${YEAR}_${TIMESTAMP} ${CONDOR_OUTPUT}/condor_jobs_${YEAR}_latest
```
...
```
python combine_years.py -y 2016APV 2016 2017 2018
```
